            ...
            <div class="book-card">
                ...
                <div class="book-card-content">
                    ...
                    <div class="card-actions" style="margin-top: 15px; border-top: 1px solid #eee; padding-top: 10px;">
                        ...
                        {{-- Jika ADMIN atau PEMILIK buku: Tampilkan Edit/Hapus --}}
                        ...
                        {{-- Jika USER BIASA: Tampilkan Tombol Pinjam --}}
                        @else
                            @if($book->isBorrowed())
                                {{-- Jika user sedang meminjam buku ini --}}
                                <button class="btn" disabled style="background: grey; cursor: not-allowed; font-size: 0.8rem; color: white;">Sedang Dipinjam</button>
                            
                            @elseif($book->stock > 0)
                                {{-- Jika stok ada, boleh pinjam --}}
                            ...
                            @else
                                {{-- Jika stok habis --}}
                                <button class="btn" disabled style="background: #e2e6ea; color: #6c757d; cursor: not-allowed; font-size: 0.8rem; border: 1px solid #ccc;">Stok Habis</button>
                            @endif
                        @endif
